...
export default function AnswerSheetAnalyzer() {
  ...
  const analyzeAnswerSheet = async () => {
    ...
    try {
      const systemPrompt = `You are an expert ${board} teacher and evaluator who specializes in providing detailed feedback on student answers. Analyze the answer sheet with precision and provide constructive feedback aligned with ${board} evaluation standards.`;
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="w-full min-w-[300px]">
            <CardWithHover title="Answer Sheet Analyzer" description="Get detailed feedback on your answers" className="w-full min-h-[600px]">
